...
ssfun = @(x,data) SumofSquaresFunction_TranscriptionCycleMCMC(construct,data,x);
...
for i = 1:size(dR0,2)
    params{end+1} = {strcat('dR',num2str(i)), x0(7+i), -30, 30, 0, ratePriorWidth}; %Fluctuations with priors around zero
end
